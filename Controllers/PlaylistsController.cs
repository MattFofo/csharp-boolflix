...
namespace boolflix.Controllers
{
    public class PlaylistsController : Controller
    {
        ...
        {
            var boolflixContext = _context.Playlists.Include(p => p.Profile);
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ProfileId")] Playlist playlist)
        {
            ...
            ViewData["ProfileId"] = new SelectList(_context.Profiles, "Id", "Id", playlist.ProfileId);
            return View(playlist);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ProfileId")] Playlist playlist)
        {
            if (id != playlist.Id)
            {
                return NotFound();
